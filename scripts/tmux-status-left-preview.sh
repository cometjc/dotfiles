...
while IFS= read -r window_id; do
    marker="$("/home/jethro/repo/dotfiles/scripts/tmux-window-viewport-marker.sh" "$window_id" 'esc to interrupt')"
    label="$("/home/jethro/repo/dotfiles/scripts/tmux-window-label.sh" "$window_id")"
